...
\center{\includegraphics[height=3.25cm, width=1\linewidth]{act_q}} a) \\
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[height=3.05cm, width=1\linewidth]{pas_q}} \\b)
\end{minipage}
...
\begin{figure}[h]
\center{\includegraphics[width=0.55\linewidth]{micro}}
\vspace{1cm} 
...
\begin{floatrow}
\ffigbox{
\center{\includegraphics[width=0.45\linewidth]{osram}} 
}{
...
\begin{figure}[H]
\begin{minipage}[h]{0.52\linewidth}
\center{\includegraphics[height=3.15cm, width=0.85\linewidth]{laser_beam_3}} \\ a) 
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[height=3.25cm, width=1\linewidth]{laser_beam_4}} \\ b)
\end{minipage}
\caption{
...
\begin{figure}[H]
\begin{minipage}[h]{0.52\linewidth}
\center{\includegraphics[width=1.2\linewidth]{lens}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\linewidth}
...
\begin{floatrow}
\ffigbox{
\center{\includegraphics[width=0.65\linewidth]{cylinder_lens}} 
}{
...
\center{\includegraphics[height=3.25cm, width=1\linewidth]{zem_1_lens}}\\ a)
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[height=3.25cm, width=1\linewidth]{zem_2_lens}}\\ b)
\end{minipage}
\vfill
\begin{minipage}[h]{0.495\linewidth}
\center{\includegraphics[height=6cm, width=1\linewidth]{spot_1_lens}} \\ c)
\end{minipage}
\hfill
\begin{minipage}[h]{0.495\linewidth}
\center{\includegraphics[height=6cm, width=1\linewidth]{spot_2_lens}} \\ d)
\end{minipage}
...
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{ld_sequential}}
...
\begin{figure}[h]
\center{\includegraphics[width=0.2\linewidth]{ld}}
